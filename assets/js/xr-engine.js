...
function enterXR() {
    ...
    if (!xrInitialized) {
        ...
        // Already initialized — just rebuild scene if missions changed
...
function _turbine(x,z,n){_box(x,5,z,0.4,10,0.4,0x7eb8ff);_sphere(x,10,z,0.5,0x7eb8ff);[0,120,240].forEach(function(d){var r=d*Math.PI/180;var b=new THREE.Mesh(new THREE.BoxGeometry(0.2,6,0.1),new THREE.MeshStandardMaterial({color:0x5a90cc}));b.position.set(x+Math.cos(r)*3,10,z+Math.sin(r)*3);b.rotation.z=r;b.castShadow=true;xrScene.add(b);});_floatLabel('T'+n,x,12,z,0x7eb8ff);}
